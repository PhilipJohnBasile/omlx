...
from omlx.patches.deepseek_v4.ratio128_policy import has_sub4_quantization
...
def test_real_checkpoint_prefill_selects_ratio128_attention_policy(
    ...
    try:
        ...
        last_logits = logits = cache = model = None
        gc.collect()
        mx.clear_cache()
